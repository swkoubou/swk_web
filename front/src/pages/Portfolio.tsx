...
const projects: Project[] = [
  {
    ...
    title: "アブラゼミ",
    description:
      "音響解析を用いたセミの鳴き声分類システム。機械学習を活用してアブラゼミの鳴き声を自動で識別します。",
  ...
  },
  {
    ...
    title: "WEBサイト",
    description:
      "ソフトウェア工房の公式Webサイト。モダンなフロントエンド技術を使用して構築されたレスポンシブサイトです。",
  ...
  },
  {
    ...
    title: "じゃんけん",
    description:
      "AIとじゃんけんができるインタラクティブなゲームアプリ。プレイヤーの傾向を学習して戦略的に対戦します。",
  ...
  },
  {
    ...
    title: "秘密道具",
    description:
      "日常生活を便利にする様々なユーティリティツール集。タスク管理、ファイル変換、データ解析など。",
  ...
  },
  {
    ...
    title: "レジュメ",
    description:
      "学生向けの履歴書・レジュメ作成支援ツール。テンプレートを選んで簡単に美しい履歴書を作成できます。",
...
function Portfolio() {
  ...
  const filteredProjects = projects.filter((project) => {
    const matchesCategory =
      selectedCategory === "すべて" || project.category === selectedCategory;
    const matchesTech =
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-2">
                      <span
                        className={`inline-block px-2 py-1 text-xs font-medium rounded-full ${statusBadge.color}`}
                      >
                        {statusBadge.text}
                      </span>
