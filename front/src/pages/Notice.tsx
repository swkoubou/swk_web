    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="space-y-6 mb-12">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <h3 className="text-xl font-bold mb-3">
            <a href="/naiyou" className="text-primary-600 hover:text-primary-500">お知らせのタイトル</a>
          </h3>
      ...
      <div className="bg-primary-50 rounded-lg p-6 max-w-md mx-auto">
        ...
        <ul className="space-y-2">
          <li><a href="/notice" className="text-primary-600 hover:text-primary-500">2024年</a></li>
