...
const activities: ActivityItem[] = [
  {
    ...
    description: "React + TypeScript + Tailwind CSSを使用した新しいサイトが完成しました。モダンなデザインと優れたユーザーエクスペリエンスを実現。",
    category: "project",
  ...
  },
  {
    ...
    date: "2024-12-10",
    title: "第3回技術勉強会開催",
    description: "「TypeScriptで始める型安全なReact開発」をテーマに勉強会を実施。実践的なハンズオンセッションも含めて開催。",
    category: "study",
    participants: ["全メンバー"],
    location: "研究室A"
  },
  {
    ...
    date: "2024-12-05",
    title: "アブラゼミプロジェクト発表",
    description: "音響解析を用いたセミの鳴き声分類システムの開発成果を学内発表会で披露。高い評価を獲得。",
  ...
  },
  {
    ...
    date: "2024-11-28",
    title: "月例ミーティング",
    description: "各プロジェクトの進捗報告と来月の計画について話し合いました。新メンバーの役割分担も決定。",
    category: "meeting",
    participants: ["全メンバー"],
    location: "研究室B"
  },
  {
    ...
    date: "2024-11-20",
    title: "ハッカソンイベント参加",
    description: "地域のハッカソンイベント「Tech Challenge 2024」に参加。「じゃんけん」プロジェクトのプロトタイプを24時間で開発。",
    category: "event",
  ...
  },
  {
    ...
    date: "2024-11-15",
    title: "Git/GitHub勉強会",
    description: "チーム開発に必要なGitの基本的な使い方から、効果的なブランチ戦略まで学習しました。",
    category: "study",
    participants: ["全メンバー"],
    location: "研究室A"
  },
  ...
  },
  {
    ...
    date: "2024-10-20",
    title: "秘密道具プロジェクト完成",
    description: "日常生活を便利にするユーティリティツール集が完成。複数の便利機能を一つのアプリケーションに統合。",
    category: "project",
...
const categoryConfig = {
  event: { name: "イベント", color: "bg-purple-100 text-purple-800", icon: "🎉" },
  project: { name: "プロジェクト", color: "bg-blue-100 text-blue-800", icon: "💻" },
  achievement: { name: "成果", color: "bg-green-100 text-green-800", icon: "🏆" },
  meeting: { name: "ミーティング", color: "bg-yellow-100 text-yellow-800", icon: "💬" },
...
function Activity() {
  ...
  const filteredActivities = activities.filter(activity => {
    ...
    const matchesYear = !selectedYear || new Date(activity.date).getFullYear() === selectedYear;
                  ...
                  <div className="grid md:grid-cols-2 gap-4 text-sm">
                    ...
                    {activity.relatedProject && (
                      <div className="md:col-span-2">
                        ...
                        <span className="text-primary-600 font-medium">{activity.relatedProject}</span>
                      </div>
                    )}
                  </div>
                </div>
